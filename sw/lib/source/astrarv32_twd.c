 ...
 **************************************************************************/
int astrarv32_twd_available(void) {

  return (int)(ASTRARV32_SYSINFO->SOC & (1 << SYSINFO_SOC_IO_TWD));
}


/**********************************************************************//**
 * Enable and configure TWD controller.
 * The TWD control register bits are listed in #ASTRARV32_TWD_CTRL_enum.
 *
 ...
 **************************************************************************/
void astrarv32_twd_setup(int device_addr, int fsel, uint32_t irq_mask) {

  ASTRARV32_TWD->CTRL = 0; // reset

  astrarv32_twd_irq_config(1, irq_mask);

  uint32_t ctrl = ASTRARV32_TWD->CTRL;
  ctrl |= ((uint32_t)(               0x01) << TWD_CTRL_EN);
  ctrl |= ((uint32_t)(device_addr  & 0x7f) << TWD_CTRL_DEV_ADDR0);
  ctrl |= ((uint32_t)(fsel         & 0x01) << TWD_CTRL_FSEL);
  ASTRARV32_TWD->CTRL = ctrl;
}
 ...
 * @param[in] irq_mask Interrupt configuration bit mask (TWD_CTRL_IRQ_* bits).
 **************************************************************************/
void astrarv32_twd_irq_config(int enable, uint32_t irq_mask) {
  ...
  if (enable) {
    __MMREG32_BSET(ASTRARV32_TWD->CTRL, irq_mask & mask);
  }
  else {
    __MMREG32_BCLR(ASTRARV32_TWD->CTRL, irq_mask & mask);
  }
}
 ...
 **************************************************************************/
int astrarv32_twd_get_rx_fifo_depth(void) {

  uint32_t tmp = (ASTRARV32_TWD->CTRL >> TWD_CTRL_RX_FIFO_LSB) & 0xf;
  return (int)(1 << tmp);
}
 ...
 **************************************************************************/
int astrarv32_twd_get_tx_fifo_depth(void) {

  uint32_t tmp = (ASTRARV32_TWD->CTRL >> TWD_CTRL_TX_FIFO_LSB) & 0xf;
  return (int)(1 << tmp);
}
 ...
 **************************************************************************/
void astrarv32_twd_disable(void) {

  __MMREG32_BCLR(ASTRARV32_TWD->CTRL, 1 << TWD_CTRL_EN);
}
 ...
 **************************************************************************/
void astrarv32_twd_enable(void) {

  __MMREG32_BSET(ASTRARV32_TWD->CTRL, 1 << TWD_CTRL_EN);
}
 ...
 * Clear TWD RX FIFO.
 **************************************************************************/
void astrarv32_twd_clear_rx(void) {

  __MMREG32_BSET(ASTRARV32_TWD->CTRL, 1 << TWD_CTRL_CLR_RX);
}
 ...
 * Clear TWD TX FIFO.
 **************************************************************************/
void astrarv32_twd_clear_tx(void) {

  __MMREG32_BSET(ASTRARV32_TWD->CTRL, 1 << TWD_CTRL_CLR_TX);
}
 ...
 **************************************************************************/
int astrarv32_twd_com_state(void) {

  return (int)(ASTRARV32_TWD->CTRL & (1 << TWD_CTRL_COM));
}
 ...
 **************************************************************************/
int astrarv32_twd_com_started(void) {

  uint32_t ctrl_tmp = ASTRARV32_TWD->CTRL;
  __MMREG32_BCLR(ASTRARV32_TWD->CTRL, 1 << TWD_CTRL_COM_END); // clear BEG if it is set, keep END
 ...
 **************************************************************************/
int astrarv32_twd_com_ended(void) {

  uint32_t ctrl_tmp = ASTRARV32_TWD->CTRL;
  __MMREG32_BCLR(ASTRARV32_TWD->CTRL, 1 << TWD_CTRL_COM_BEG); // clear END if it is set, keep BEG
 ...
 **************************************************************************/
int astrarv32_twd_rx_available(void) {

  return (int)(ASTRARV32_TWD->CTRL & (1 << TWD_CTRL_RX_AVAIL));
}
 ...
 **************************************************************************/
int astrarv32_twd_rx_full(void) {

  return (int)(ASTRARV32_TWD->CTRL & (1 << TWD_CTRL_RX_FULL));
}
 ...
 **************************************************************************/
int astrarv32_twd_tx_empty(void) {

  return (int)(ASTRARV32_TWD->CTRL & (1 << TWD_CTRL_TX_EMPTY));
}
 ...
 **************************************************************************/
int astrarv32_twd_tx_full(void) {

  return (int)(ASTRARV32_TWD->CTRL & (1 << TWD_CTRL_TX_FULL));
}
 ...
 **************************************************************************/
void astrarv32_twd_put(uint8_t data) {

  ASTRARV32_TWD->DATA = data;
}
 ...
 **************************************************************************/
uint8_t astrarv32_twd_get(void) {

  return ASTRARV32_TWD->DATA;
}
