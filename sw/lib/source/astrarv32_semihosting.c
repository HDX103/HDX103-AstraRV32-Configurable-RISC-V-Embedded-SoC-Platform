 ...
 **************************************************************************/
void astrarv32_semihosting_putc(char c) {
  astrarv32_semihosting_req(SEMIHOSTING_SYS_WRITEC, (void*)&c);
}
 ...
 **************************************************************************/
void astrarv32_semihosting_puts(const char* pnt) {
  astrarv32_semihosting_req(SEMIHOSTING_SYS_WRITE0, (void*)pnt);
}
 ...
 **************************************************************************/
char astrarv32_semihosting_getc(void) {
  return (char)astrarv32_semihosting_req(SEMIHOSTING_SYS_READC, NULL);
}
 ...
 * @return File handle.
 **************************************************************************/
int astrarv32_semihosting_open(char *path, int mode) {
  uint32_t args[3];
  args[0] = (uint32_t)path;
  args[1] = (uint32_t)mode;
  args[2] = (uint32_t)strlen(path);
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_OPEN, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_close(int file) {
  uint32_t args[1];
  args[0] = (uint32_t)file;
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_CLOSE, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_write(int file, char *buffer, int len) {
  uint32_t args[3];
  args[0] = (uint32_t)file;
  args[1] = (uint32_t)buffer;
  args[2] = (uint32_t)len;
  return len - (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_WRITE, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_read(int file, char *buffer, int len) {
  uint32_t args[3];
  args[0] = (uint32_t)file;
  args[1] = (uint32_t)buffer;
  args[2] = (uint32_t)len;
  return len - (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_READ, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_istty(int file) {
  uint32_t args[1];
  args[0] = (uint32_t)file;
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_ISTTY, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_seek(int file, int pos) {
  uint32_t args[2];
  args[0] = (uint32_t)file;
  args[1] = (uint32_t)pos;
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_SEEK, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_flen(int file) {
  uint32_t args[1];
  args[0] = (uint32_t)file;
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_FLEN, (void*)args);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_time(void) {
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_TIME, NULL);
}
 ...
 **************************************************************************/
int astrarv32_semihosting_system(char *cmd) {
  uint32_t args[2];
  args[0] = (uint32_t)cmd;
  args[1] = (uint32_t)strlen(cmd);
  return (int)astrarv32_semihosting_req(SEMIHOSTING_SYS_SYSTEM, (void*)args);
}
