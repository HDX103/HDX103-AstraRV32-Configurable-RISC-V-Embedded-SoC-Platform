 ...
 **************************************************************************/
int astrarv32_neoled_available(void) {

  return (int)(ASTRARV32_SYSINFO->SOC & (1 << SYSINFO_SOC_IO_NEOLED));
}
 ...
 **************************************************************************/
void astrarv32_neoled_enable(void) {

  __MMREG32_BSET(ASTRARV32_NEOLED->CTRL, 1 << NEOLED_CTRL_EN);
}
 ...
 **************************************************************************/
void astrarv32_neoled_disable(void) {

  __MMREG32_BCLR(ASTRARV32_NEOLED->CTRL, 1 << NEOLED_CTRL_EN);
}


/**********************************************************************//**
 * Enable and configure NEOLED controller. The NEOLED control register bits are listed in #ASTRARV32_NEOLED_CTRL_enum.
 ...
 **************************************************************************/
void astrarv32_neoled_setup(uint32_t prsc, uint32_t t_total, uint32_t t_high_zero, uint32_t t_high_one) {

  ASTRARV32_NEOLED->CTRL = 0; // reset
 ...
 **************************************************************************/
void astrarv32_neoled_setup_ws2812(void) {
  ...
  uint32_t t_clock_x500ps = (2 * 1000 * 1000 * 1000) / astrarv32_sysinfo_get_clk();
...
//astrarv32_uart0_printf("NEOLED.clk_prsc: %u\n", clk_prsc_fac); // DEBUG

    t_base = t_clock_x500ps * clk_prsc_fac;

//astrarv32_uart0_printf("NEOLED.t_base: %u x 0.5ns\n", t_base); // DEBUG
...
//astrarv32_uart0_printf("NEOLED.t_total:     %u\n", t_total); // DEBUG
//astrarv32_uart0_printf("NEOLED.t_high_zero: %u\n", t_high_zero); // DEBUG
//astrarv32_uart0_printf("NEOLED.t_high_one:  %u\n", t_high_one); // DEBUG
  ...
  astrarv32_neoled_setup(clk_prsc_sel, t_total, t_high_zero, t_high_one);
}
 ...
 **************************************************************************/
void astrarv32_neoled_strobe_blocking(void) {

  // wait for FIFO full flag to clear
  while (ASTRARV32_NEOLED->CTRL & (1 << NEOLED_CTRL_TX_FULL));
  ASTRARV32_NEOLED->STROBE = 0; // just write any data
}
 ...
 **************************************************************************/
void astrarv32_neoled_strobe_nonblocking(void) {
 ...
 **************************************************************************/
void astrarv32_neoled_write32_blocking(uint32_t data) {

  // wait for FIFO full flag to clear
  while (ASTRARV32_NEOLED->CTRL & (1 << NEOLED_CTRL_TX_FULL));
  ASTRARV32_NEOLED->DATA32 = data;
}
 ...
 * @param[in] 32-bit RGBW data
 **************************************************************************/
void astrarv32_neoled_write32_nonblocking(uint32_t data) {
 ...
 **************************************************************************/
void astrarv32_neoled_write24_blocking(uint32_t data) {

  // wait for FIFO full flag to clear
  while (ASTRARV32_NEOLED->CTRL & (1 << NEOLED_CTRL_TX_FULL));
  ASTRARV32_NEOLED->DATA24 = data;
}
 ...
 * @param[in] LSB-aligned 24-bit RGBW data
 **************************************************************************/
void astrarv32_neoled_write24_nonblocking(uint32_t data) {
 ...
 **************************************************************************/
int astrarv32_neoled_get_fifo_depth(void) {

  uint32_t tmp = (ASTRARV32_NEOLED->CTRL >> NEOLED_CTRL_FIFO_LSB) & 0xfu;
  return (int)(1 << tmp);
}
 ...
 **************************************************************************/
int astrarv32_neoled_fifo_full(void) {

  return (int)(ASTRARV32_NEOLED->CTRL & (1 << NEOLED_CTRL_TX_FULL));
}
 ...
 **************************************************************************/
int astrarv32_neoled_fifo_empty(void) {

  return (int)(ASTRARV32_NEOLED->CTRL & (1 << NEOLED_CTRL_TX_EMPTY));
}
 ...
 **************************************************************************/
int astrarv32_neoled_busy(void) {

  return (int)(ASTRARV32_NEOLED->CTRL & (1 << NEOLED_CTRL_TX_BUSY));
}
