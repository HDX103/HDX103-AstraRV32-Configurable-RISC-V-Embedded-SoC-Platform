...
#ifndef ASTRARV32_INTRINSICS_H
#define ASTRARV32_INTRINSICS_H

#include <astrarv32.h>
#include <stdint.h>

/**********************************************************************//**
 * @name RISC-V opcodes for custom instructions / ASTRARV32 CFU
 **************************************************************************/
/**@{*/
