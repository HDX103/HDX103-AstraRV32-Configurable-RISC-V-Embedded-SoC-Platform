...
/**
 * @file astrarv32_semihosting.h
 * @brief RISC-V semihosting header file.
 */

#ifndef ASTRARV32_SEMIHOSTING_H
#define ASTRARV32_SEMIHOSTING_H
 ...
 **************************************************************************/
static inline int __attribute__ ((always_inline)) astrarv32_semihosting_req(int id, void* arg) {
