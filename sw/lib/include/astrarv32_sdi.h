...
/**
 * @file astrarv32_sdi.h
 * @brief Serial data interface controller (SDI) HW driver header file.
 */

#ifndef ASTRARV32_SDI_H
#define ASTRARV32_SDI_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL; /**< offset 0: control register (#ASTRARV32_SDI_CTRL_enum) */
  uint32_t DATA; /**< offset 4: data register */
} astrarv32_sdi_t;

/** SDI module hardware handle (#astrarv32_sdi_t) */
#define ASTRARV32_SDI ((astrarv32_sdi_t*) (ASTRARV32_SDI_BASE))

/** SDI control register bits */
enum ASTRARV32_SDI_CTRL_enum {
