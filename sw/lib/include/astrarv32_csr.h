...
/**
 * @file astrarv32_csr.h
 * @brief Control and Status Registers (CSR) definitions.
 */

#ifndef ASTRARV32_CSR_H
#define ASTRARV32_CSR_H
...
enum ASTRARV32_CSR_enum {
  ...
  CSR_MCAUSE         = 0x342, /**< 0x342 - mcause:   Machine trap cause (#ASTRARV32_EXCEPTION_CODES_enum) */
  CSR_MTVAL          = 0x343, /**< 0x343 - mtval:    Machine trap value */
  CSR_MIP            = 0x344, /**< 0x344 - mip:      Machine interrupt pending register (#ASTRARV32_CSR_MIP_enum) */
 ...
 **************************************************************************/
enum ASTRARV32_CSR_FFLAGS_enum {
 ...
 **************************************************************************/
enum ASTRARV32_CSR_MCOUNTEREN_enum {
 ...
 **************************************************************************/
enum ASTRARV32_CSR_MSTATUS_enum {
 ...
 **************************************************************************/
enum ASTRARV32_CSR_MCOUNTINHIBIT_enum {
...
enum ASTRARV32_CSR_MIE_enum {
  ...
  /* ASTRARV32-specific extension: Fast Interrupt Requests (FIRQ) */
...
/**********************************************************************//**
 * mxisa[h] CSR (r/-): Machine extended instruction set extensions (ASTRARV32-specific)
 **************************************************************************/
enum ASTRARV32_CSR_MXISA_enum {
...
enum ASTRARV32_CSR_MXISAH_enum {
 ...
 **************************************************************************/
enum ASTRARV32_CSR_MCYCLECFGH_enum {
 ...
 **************************************************************************/
enum ASTRARV32_CSR_MINSTRETCFGH_enum {
 ...
 **************************************************************************/
enum ASTRARV32_HPMCNT_EVENT_enum {
 ...
 **************************************************************************/
enum ASTRARV32_PMPCFG_ATTRIBUTES_enum {
  PMPCFG_R     = 0, /**< pmpcfg attribute (0): Read */
  PMPCFG_W     = 1, /**< pmpcfg attribute (1): Write */
  PMPCFG_X     = 2, /**< pmpcfg attribute (2): Execute */
  PMPCFG_A_LSB = 3, /**< pmpcfg attribute (3): Mode LSB #ASTRARV32_PMP_MODES_enum */
  PMPCFG_A_MSB = 4, /**< pmpcfg attribute (4): Mode MSB #ASTRARV32_PMP_MODES_enum */
 ...
 **************************************************************************/
enum ASTRARV32_EXCEPTION_CODES_enum {
