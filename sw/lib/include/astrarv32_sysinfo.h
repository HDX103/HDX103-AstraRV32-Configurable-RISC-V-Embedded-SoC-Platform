...
/**
 * @file astrarv32_sysinfo.h
 * @brief System Information Memory (SYSINFO) HW driver header file.
 */

#ifndef ASTRARV32_SYSINFO_H
#define ASTRARV32_SYSINFO_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  ...
  const uint32_t MISC;  /**< Miscellaneous system configurations (#ASTRARV32_SYSINFO_MISC_enum) */
  const uint32_t SOC;   /**< SoC features (#ASTRARV32_SYSINFO_SOC_enum) */
  const uint32_t CACHE; /**< Cache configuration (#ASTRARV32_SYSINFO_CACHE_enum) */
} astrarv32_sysinfo_t;

/** SYSINFO module hardware handle (#astrarv32_sysinfo_t) */
#define ASTRARV32_SYSINFO ((astrarv32_sysinfo_t*) (ASTRARV32_SYSINFO_BASE))

/** ASTRARV32_SYSINFO.MISC (r/-): Miscellaneous system configurations */
enum ASTRARV32_SYSINFO_MISC_enum {
...
/** ASTRARV32_SYSINFO.SOC (r/-): Implemented processor devices/features */
enum ASTRARV32_SYSINFO_SOC_enum {
...
/** ASTRARV32_SYSINFO.CACHE (r/-): Cache configuration */
 enum ASTRARV32_SYSINFO_CACHE_enum {
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_is_sim(void) {
  return (uint32_t)(ASTRARV32_SYSINFO->SOC >> SYSINFO_SOC_SIM);
}
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_numcores(void) {
  return (uint32_t)((ASTRARV32_SYSINFO->MISC >> SYSINFO_MISC_HART_LSB) & 0x0fu);
}
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_imemsize(void) {
  uint32_t tmp = (ASTRARV32_SYSINFO->MISC >> SYSINFO_MISC_IMEM_LSB) & 0xffu;
  if (tmp) {
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_dmemsize(void) {
  uint32_t tmp = (ASTRARV32_SYSINFO->MISC >> SYSINFO_MISC_DMEM_LSB) & 0xffu;
  if (tmp) {
    return (uint32_t)(1u << tmp);
  }
  return 0;
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_bootmode(void) {
  return (uint32_t)((ASTRARV32_SYSINFO->MISC >> SYSINFO_MISC_BOOT_LSB) & 0x03u);
}
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_intbustimeout(void) {
  uint32_t tmp = (ASTRARV32_SYSINFO->MISC >> SYSINFO_MISC_ITMO_LSB) & 0x1fu;
  if (tmp) {
    return (uint32_t)(1u << tmp);
  }
  return 0;
 ...
 * @return Bus timeout cycles.
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_extbustimeout(void) {
  uint32_t tmp = (ASTRARV32_SYSINFO->MISC >> SYSINFO_MISC_ETMO_LSB) & 0x1fu;
  if (tmp) {
    return (uint32_t)(1u << tmp);
  }
  return 0;
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_sysinfo_get_clk(void) {
  return ASTRARV32_SYSINFO->CLK;
}
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_sysinfo_set_clk(uint32_t clock) {
  ASTRARV32_SYSINFO->CLK = clock;
}

#endif // ASTRARV32_SYSINFO_H
