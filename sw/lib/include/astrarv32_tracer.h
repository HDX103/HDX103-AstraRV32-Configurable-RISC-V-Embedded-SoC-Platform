...
/**
 * @file astrarv32_tracer.h
 * @brief Execution trace buffer (TRACER) HW driver header file.
 */

#ifndef ASTRARV32_TRACER_H
#define ASTRARV32_TRACER_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t       CTRL;      /**< control register (#ASTRARV32_TRACER_CTRL_enum) */
...
/** TRACER module hardware handle (#astrarv32_tracer_t) */
#define ASTRARV32_TRACER ((astrarv32_tracer_t*) (ASTRARV32_TRACER_BASE))

/** TRACER control register bits */
enum ASTRARV32_TRACER_CTRL_enum {
 ...
 * Start tracing.
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_tracer_start(void) {
  __MMREG32_BSET(ASTRARV32_TRACER->CTRL, 1 << TRACER_CTRL_START);
}

/**********************************************************************//**
 * Stop tracing.
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_tracer_stop(void) {
  __MMREG32_BSET(ASTRARV32_TRACER->CTRL, 1 << TRACER_CTRL_STOP);
}

#endif // ASTRARV32_TRACER_H
