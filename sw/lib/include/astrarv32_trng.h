...
/**
 * @file astrarv32_trng.h
 * @brief True Random Number Generator (TRNG) HW driver header file.
 */

#ifndef ASTRARV32_TRNG_H
#define ASTRARV32_TRNG_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t       CTRL; /**< offset 0: control register (#ASTRARV32_TRNG_CTRL_enum) */
  const uint32_t DATA; /**< offset 4: random data register (#ASTRARV32_TRNG_DATA_enum) */
} astrarv32_trng_t;

/** TRNG module hardware handle (#astrarv32_trng_t) */
#define ASTRARV32_TRNG ((astrarv32_trng_t*) (ASTRARV32_TRNG_BASE))

/** TRNG control register bits */
enum ASTRARV32_TRNG_CTRL_enum {
