...
/**
 * @file astrarv32_twi.h
 * @brief Two-Wire Interface Controller (TWI) HW driver header file.
 */

#ifndef ASTRARV32_TWI_H
#define ASTRARV32_TWI_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL; /**< offset 0: control register (#ASTRARV32_TWI_CTRL_enum) */
  uint32_t DCMD; /**< offset 4: data/command register (#ASTRARV32_TWI_DCMD_enum) */
} astrarv32_twi_t;

/** TWI module hardware handle (#astrarv32_twi_t) */
#define ASTRARV32_TWI ((astrarv32_twi_t*) (ASTRARV32_TWI_BASE))

/** TWI control register bits */
enum ASTRARV32_TWI_CTRL_enum {
...
enum ASTRARV32_TWI_DCMD_enum {
  ...
  TWI_DCMD_CMD_LO =  9, /**< TWI data register(9)  (r/w): Operation command (#ASTRARV32_TWI_DCMD_CMD_enum), LSB */
  TWI_DCMD_CMD_HI = 10  /**< TWI data register(10) (r/w): Operation command (#ASTRARV32_TWI_DCMD_CMD_enum), MSB */
};
/**@}*/
 ...
 **************************************************************************/
/**@{*/
enum ASTRARV32_TWI_DCMD_CMD_enum {
