...
/**
 * @file astrarv32_smc.h
 * @brief Serial memory controller (SMC) HW driver header file.
 */

#ifndef ASTRARV32_SMC_H
#define ASTRARV32_SMC_H
...
/** SMC hardware handle (#astrarv32_smc_t) */
#define ASTRARV32_SMC ((astrarv32_smc_t*) (ASTRARV32_SMC_BASE))

/** SMC control and status register 0 (CSR0) bits */
enum ASTRARV32_SMC_CFG0_enum {
