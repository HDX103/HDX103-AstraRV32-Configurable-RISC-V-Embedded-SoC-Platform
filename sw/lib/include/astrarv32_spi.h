...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL;  /**< offset 0: control register (#ASTRARV32_SPI_CTRL_enum) */
  uint32_t DATA;  /**< offset 4: data register  (#ASTRARV32_SPI_DATA_enum) */
} astrarv32_spi_t;

/** SPI module hardware handle (#astrarv32_spi_t) */
#define ASTRARV32_SPI ((astrarv32_spi_t*) (ASTRARV32_SPI_BASE))

/** SPI control register bits */
enum ASTRARV32_SPI_CTRL_enum {
