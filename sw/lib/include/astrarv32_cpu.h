...
/**
 * @file astrarv32_cpu.h
 * @brief CPU Core Functions HW driver header file.
 */

#ifndef ASTRARV32_CPU_H
#define ASTRARV32_CPU_H
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_store_unsigned_word(uint32_t addr, uint32_t wdata) {
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_store_unsigned_half(uint32_t addr, uint16_t wdata) {
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_store_unsigned_byte(uint32_t addr, uint8_t wdata) {
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_load_unsigned_word(uint32_t addr) {
 ...
 **************************************************************************/
static inline uint16_t __attribute__ ((always_inline)) astrarv32_cpu_load_unsigned_half(uint32_t addr) {
 ...
 * @return Read data half-word (16-bit).
 **************************************************************************/
static inline int16_t __attribute__ ((always_inline)) astrarv32_cpu_load_signed_half(uint32_t addr) {
 ...
 **************************************************************************/
static inline uint8_t __attribute__ ((always_inline)) astrarv32_cpu_load_unsigned_byte(uint32_t addr) {
 ...
 * @return Read data byte (8-bit).
 **************************************************************************/
static inline int8_t __attribute__ ((always_inline)) astrarv32_cpu_load_signed_byte(uint32_t addr) {
 ...
 *
 * @param[in] csr_id ID of CSR to read. See #ASTRARV32_CSR_enum.
 * @return Read data (uint32_t).
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_csr_read(const int csr_id) {
 ...
 *
 * @param[in] csr_id ID of CSR to write. See #ASTRARV32_CSR_enum.
 * @param[in] data Data to write (uint32_t).
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_csr_write(const int csr_id, uint32_t data) {
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_csr_set(const int csr_id, uint32_t mask) {
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_csr_clr(const int csr_id, uint32_t mask) {
 ...
 *
 * @param[in] csr_id ID of CSR. See #ASTRARV32_CSR_enum.
 * @param[in] wdata New data to write to selected CSR.
 * @return Old data read from selected CSR.
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_csr_swap(const int csr_id, uint32_t wdata) {
 ...
 * @return Read data word (32-bit).
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amolr(uint32_t addr) {
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amosc(uint32_t addr, uint32_t wdata) {
 ...
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amoswap(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amoadd(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amoxor(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amoand(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amoor(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amomin(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amomax(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amominu(uint32_t addr, uint32_t wdata) {
 ...
 * @return Pre-operation memory content
 **************************************************************************/
static inline uint32_t __attribute__ ((always_inline)) astrarv32_cpu_amomaxu(uint32_t addr, uint32_t wdata) {
 ...
 **************************************************************************/
static inline void __attribute__ ((always_inline)) astrarv32_cpu_sleep(void) {

  asm volatile ("wfi");
}


#endif // ASTRARV32_CPU_H
