...
/**
 * @file astrarv32_neoled.h
 * @brief Smart LED Interface (NEOLED) HW driver header file.
 */

#ifndef ASTRARV32_NEOLED_H
#define ASTRARV32_NEOLED_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL;   /**< control register (#ASTRARV32_NEOLED_CTRL_enum) */
...
/** NEOLED module hardware handle (#astrarv32_neoled_t) */
#define ASTRARV32_NEOLED ((astrarv32_neoled_t*) (ASTRARV32_NEOLED_BASE))

/** NEOLED control register bits */
enum ASTRARV32_NEOLED_CTRL_enum {
