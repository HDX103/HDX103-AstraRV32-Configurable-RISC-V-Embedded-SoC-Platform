...
/**
 * @file astrarv32_twd.h
 * @brief Two-Wire Device Controller (TWD) HW driver header file.
 */

#ifndef ASTRARV32_TWD_H
#define ASTRARV32_TWD_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL; /**< offset 0: control register (#ASTRARV32_TWD_CTRL_enum) */
  uint32_t DATA; /**< offset 4: data register (#ASTRARV32_TWD_DATA_enum) */
} astrarv32_twd_t;

/** TWD module hardware handle (#astrarv32_twd_t) */
#define ASTRARV32_TWD ((astrarv32_twd_t*) (ASTRARV32_TWD_BASE))

/** TWD control register bits */
enum ASTRARV32_TWD_CTRL_enum {
