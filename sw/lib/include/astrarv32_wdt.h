...
/**
 * @file astrarv32_wdt.h
 * @brief Watchdog Timer (WDT) HW driver header file.
 */

#ifndef ASTRARV32_WDT_H
#define ASTRARV32_WDT_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL;  /**< offset 0: control register (#ASTRARV32_WDT_CTRL_enum) */
  uint32_t RESET; /**< offset 4: WDT reset trigger (write password to "feed" watchdog) */
} astrarv32_wdt_t;

/** WDT module hardware handle (#astrarv32_wdt_t) */
#define ASTRARV32_WDT ((astrarv32_wdt_t*) (ASTRARV32_WDT_BASE))

/** WDT control register bits */
enum ASTRARV32_WDT_CTRL_enum {
 ...
 * Reset Cause
 **************************************************************************/
enum ASTRARV32_WDT_RCAUSE_enum {
