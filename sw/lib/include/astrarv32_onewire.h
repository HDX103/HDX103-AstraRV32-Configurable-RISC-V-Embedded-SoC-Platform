...
/**
 * @file astrarv32_onewire.h
 * @brief 1-Wire Interface Controller (ONEWIRE) HW driver header file.
 */

#ifndef ASTRARV32_ONEWIRE_H
#define ASTRARV32_ONEWIRE_H
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL; /**< offset 0: control register (#ASTRARV32_ONEWIRE_CTRL_enum) */
  uint32_t DCMD; /**< offset 4: command and data register (#ASTRARV32_ONEWIRE_DCMD_enum) */
} astrarv32_onewire_t;

/** ONEWIRE module hardware handle (#astrarv32_onewire_t) */
#define ASTRARV32_ONEWIRE ((astrarv32_onewire_t*) (ASTRARV32_ONEWIRE_BASE))

/** ONEWIRE control register bits */
enum ASTRARV32_ONEWIRE_CTRL_enum {
...
enum ASTRARV32_ONEWIRE_DCMD_enum {
