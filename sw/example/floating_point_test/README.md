# ASTRARV32 `Zfinx` Floating-Point Extension

The ASTRARV32 floating-point unit (FPU) implements the `Zfinx` RISC-V extension. The extension can be
...
:information_source: See the according section of the ASTRARV32 data sheet for more information.


## Intrinsic Library

The ASTRARV32 `Zfinx` floating-point extension can still be used using the provided **intrinsic library**. This
...
`astrarv32_zfinx_extension_intrinsics.h`. The provided test program `main.c` verifies all currently implemented
...
NOTE: The ASTRARV32 FPU does not support subnormal numbers yet. Subnormal numbers are flushed to zero.
