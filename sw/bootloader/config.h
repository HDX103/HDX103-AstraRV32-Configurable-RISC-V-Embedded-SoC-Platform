...
// Serial memory controller setup argument list (astrarv32_smc_setup())
#ifndef SMC_SETUP_ARGS
#define SMC_SETUP_ARGS \
  0,             /* chip select: single-chip mode, use only one PSRAM        */ \
  SMC_MSIZE_2MB, /* PSRAM size = 2MB (#ASTRARV32_SMC_MSIZE_enum)               */ \
...
// TWI flash clock prescaler (#ASTRARV32_CLOCK_PRSC_enum)
...
// SPI flash clock prescaler (#ASTRARV32_CLOCK_PRSC_enum)
...
// SD card SPI clock prescaler (#ASTRARV32_CLOCK_PRSC_enum)
...
// Intro text (string)
#ifndef THEME_INTRO
#define THEME_INTRO "ASTRARV32 Bootloader"
#endif

// Name of expected executable for UART upload (string)
#ifndef THEME_EXE
#define THEME_EXE "astrarv32_exe.bin"
#endif
