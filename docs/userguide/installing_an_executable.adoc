...
[start=2]
. Regenerate and re-install the default IMEM initialization file (`rtl/core/astrarv32_imem_image.vhd`)
so that it contains the image of your actual application firmware.

[source,bash]
----
astrarv32/sw/example/demo_blink_led$ make clean_all image install
Memory utilization:
   text    data     bss     dec     hex filename
  22192    1352    4216   27760    6c70 main.elf
Compiling image generator...
Generating astrarv32_imem_image.vhd
Installing application image to ../../../rtl/core/astrarv32_imem_image.vhd
----
