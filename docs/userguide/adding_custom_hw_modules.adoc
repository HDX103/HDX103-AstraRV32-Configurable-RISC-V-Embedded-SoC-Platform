...
In resemblance to the RISC-V ISA, the ASTRARV32 processor was designed to ease customization and extensibility.
...
The https://stnolting.github.io/astrarv32/#_processor_external_bus_interface_xbus[External Bus Interface]
...
external bus interface is mapped into the processor's https://stnolting.github.io/astrarv32/#_address_space[address space].
...
The https://stnolting.github.io/astrarv32/#_custom_functions_subsystem_cfs[Custom Functions Subsystem (CFS)] is
...
The https://stnolting.github.io/astrarv32/#_custom_functions_unit_cfu[Custom Functions Unit (CFU)] is a functional
...
* https://stnolting.github.io/astrarv32/#_custom_functions_unit_cfu[Custom Functions Unit (CFU)] for CPU-internal custom RISC-V instructions
* https://stnolting.github.io/astrarv32/#_custom_functions_subsystem_cfs[Custom Functions Subsystem (CFS)] for tightly-coupled processor-internal co-processors
* https://stnolting.github.io/astrarv32/#_processor_external_memory_interface_wishbone[External Bus Interface (WISHBONE)] for processor-external memory-mapped modules
