...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_spi.vhd    |
| Software driver files:  | astrarv32_spi.c      | link:https://stnolting.github.io/astrarv32/sw/astrarv32__spi_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_spi.h      | link:https://stnolting.github.io/astrarv32/sw/astrarv32__spi_8h.html[Online software reference (Doxygen)]
...
The ASTRARV32 SPI module provides a **host-mode** serial peripheral interface. The module operates on byte-wide data,
...
.Host-Mode Only
[NOTE]
The ASTRARV32 SPI module only supports _host mode_. Transmission are initiated only by the SPI
...
.SPI register map (`struct ASTRARV32_SPI`)
[cols="<2,<1,<4,^1,<7"]
