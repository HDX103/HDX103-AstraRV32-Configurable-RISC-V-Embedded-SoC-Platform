...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_dma.vhd     |
| Software driver files:  | astrarv32_dma.c       | link:https://stnolting.github.io/astrarv32/sw/astrarv32__dma_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_dma.h       | link:https://stnolting.github.io/astrarv32/sw/astrarv32__dma_8h.html[Online software reference (Doxygen)]
...
The ASTRARV32 DMA features a lightweight direct memory access controller that allows to move and modify data independently
...
.DMA Register Map (`struct ASTRARV32_DMA`)
[cols="<2,<1,<4,^1,<7"]
[options="header",grid="all"]
|=======================
