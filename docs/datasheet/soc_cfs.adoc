...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_cfs.vhd    |
| Software driver files:  | astrarv32_cfs.c      | link:https://stnolting.github.io/astrarv32/sw/astrarv32__cfs_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_cfs.h      | link:https://stnolting.github.io/astrarv32/sw/astrarv32__cfs_8h.html[Online software reference (Doxygen)]
...
networking (e.g. CAN), real-time data transport (e.g. I2S) or just replication of existent ASTRARV32 peripherals
...
.CFS Template
[TIP]
Take a look at the template CFS VHDL source file (`rtl/core/astrarv32_cfs.vhd`). The file is highly
...
ASTRARV32_CFS->REG[0] = (uint32_t)some_data_array(i); // write to CFS register 0
int temp = (int)ASTRARV32_CFS->REG[20]; // read from CFS register 20
----
...
.CFS register map (`struct ASTRARV32_CFS`)
[cols="^4,<2,^2,^2,<6"]
