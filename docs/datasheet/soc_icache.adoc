...
|                         | astrarv32_cache_ram.vhd | tag and data RAM (primitive/IP wrapper)
...
.Memory Primitives
[TIP]
The cache's tag and data RAMs are encapsulated as wrapper (`astrarv32_cache_ram.vhd`) that can be modified or
