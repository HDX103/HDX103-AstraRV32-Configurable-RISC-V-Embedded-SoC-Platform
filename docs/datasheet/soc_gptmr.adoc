...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_gptmr.vhd   |
| Software driver files:  | astrarv32_gptmr.c     | link:https://stnolting.github.io/astrarv32/sw/astrarv32__gptmr_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_gptmr.h     | link:https://stnolting.github.io/astrarv32/sw/astrarv32__gptmr_8h.html[Online software reference (Doxygen)]
...
.GPTMR register map (`struct ASTRARV32_GPTMR`)
[cols="<4,<2,<4,^1,<7"]
...
| `0xfff10000` | `CSR0.ENABLE`   | `15:0` | r/w | Control and status register 0 - Slice enable (one bit per implemented slice starting at LSB).
| `0xfff10002` | `CSR0.MODE`     | `15:0` | r/w | Control and status register 0 - Slice operation mode: 0 = single shot, 1 = continuous (one bit per implemented slice starting at LSB).
| `0xfff10004` | `CSR1.WORD`     | `31:0` | r/w | Control and status register 1 full-word access.
| `0xfff10004` | `CSR1.IRQ`      | `15:0` | r/w | Control and status register 1 - Slice interrupt pending (one bit per implemented slice starting at LSB); write 0 to clear interrupt.
| `0xfff10006` | `CSR1.PRSC`     |  `2:0` | r/w | Control and status register 1 - Global clock prescaler select.
| `0xfff10080` | `SLICE[0].CNT`  | `31:0` | r/w | Slice 0 counter register.
| `0xfff10084` | `SLICE[0].THR`  | `31:0` | r/w | Slice 0 threshold register.
| ...          | ...             | ...    | ... | ...
| `0xfff100F8` | `SLICE[15].CNT` | `31:0` | r/w | Slice 15 counter register.
| `0xfff100FC` | `SLICE[15].THR` | `31:0` | r/w | Slice 15 threshold register.
|=======================
