...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_xbus.vhd     | External bus gateway
...
|                         | (`CACHE_BLOCK_SIZE`) | burst size (defined by global cache block size)
...
{signal: [
  ...
  {name: 'xbus_cti_o',  wave: 'x7.....x', data: ['001 (const. address burst)']},
...
{signal: [
  ...
  {name: 'xbus_cti_o',  wave: 'x7.....x.', data: ['010 (inc. address burst)']},
  {name: 'xbus_tag_o',  wave: 'x2.....x.'},
