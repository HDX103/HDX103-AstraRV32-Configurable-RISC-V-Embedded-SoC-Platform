...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_neoled.vhd  |
| Software driver files:  | astrarv32_neoled.c    | link:https://stnolting.github.io/astrarv32/sw/astrarv32__neoled_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_neoled.h    | link:https://stnolting.github.io/astrarv32/sw/astrarv32__neoled_8h.html[Online software reference (Doxygen)]
...
[TIP]
The NEOLED SW driver library (`astrarv32_neoled.h`) provides a simplified configuration
...
.NEOLED register map (`struct ASTRARV32_NEOLED`)
[cols="<2,<1,<5,^1,<5"]
