...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_onewire.vhd |
| Software driver files:  | astrarv32_onewire.c   | link:https://stnolting.github.io/astrarv32/sw/astrarv32__onewire_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_onewire.h   | link:https://stnolting.github.io/astrarv32/sw/astrarv32__onewire_8h.html[Online software reference (Doxygen)]
...
The ASTRARV32 ONEWIRE module implements a single-wire interface controller that is compatible to the
...
.Hardwired timing configuration in `astrarv32_onewire.vhd`
[source,VHDL]
----
...
.ONEWIRE register map (`struct ASTRARV32_ONEWIRE`)
[cols="<4,<2,<6,^2,<6"]
