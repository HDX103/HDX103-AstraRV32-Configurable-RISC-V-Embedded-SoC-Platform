...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_slink.vhd   |
| Software driver files:  | astrarv32_slink.c     | link:https://stnolting.github.io/astrarv32/sw/astrarv32__slink_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_slink.h     | link:https://stnolting.github.io/astrarv32/sw/astrarv32__slink_8h.html[Online software reference (Doxygen)]
...
https://stnolting.github.io/astrarv32/ug/#_packaging_the_processor_as_vivado_ip_block
...
.SLINK register map (`struct ASTRARV32_SLINK`)
[cols="<2,<2,<4,^1,<4"]
