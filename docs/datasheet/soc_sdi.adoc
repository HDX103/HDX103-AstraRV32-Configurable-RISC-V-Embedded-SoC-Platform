...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_sdi.vhd     |
| Software driver files:  | astrarv32_sdi.c       | link:https://stnolting.github.io/astrarv32/sw/astrarv32__sdi_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_sdi.h       | link:https://stnolting.github.io/astrarv32/sw/astrarv32__sdi_8h.html[Online software reference (Doxygen)]
...
.Device-Mode Only
[NOTE]
The ASTRARV32 SDI module only supports _device mode_. If you are looking for a _host-mode_ serial peripheral
interface (transactions performed by the ASTRARV32) check out the <<_serial_peripheral_interface_controller_spi>>.
...
.SDI register map (`struct ASTRARV32_SDI`)
[cols="<2,<1,<4,^1,<7"]
...
.2+<| `0xfff70004` .2+<| `DATA` <|`7:0`  `SDI_DATA_MSB : SDI_DATA_LSB` ^| r/w <| receive/transmit data (FIFO)
