...
[grid="none"]
|=======================
| Hardware source files:  | astrarv32_wdt.vhd |
| Software driver files:  | astrarv32_wdt.c   | link:https://stnolting.github.io/astrarv32/sw/astrarv32__wdt_8c.html[Online software reference (Doxygen)]
|                         | astrarv32_wdt.h   | link:https://stnolting.github.io/astrarv32/sw/astrarv32__wdt_8h.html[Online software reference (Doxygen)]
...
****
T~timoeut~ = ( 1 / f~main~[Hz] ) * 4096 * `WDT_CTRL_TIMEOUT`
****
...
.WDT register map (`struct ASTRARV32_WDT`)
[cols="<2,<1,<4,^1,^1,^2,<4"]
