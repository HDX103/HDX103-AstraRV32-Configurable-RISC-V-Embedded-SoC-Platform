-- ================================================================================ --
-- ASTRARV32 - Default Processor Testbench                                            --
-- -------------------------------------------------------------------------------- --
...
architecture astrarv32_tb_rtl of astrarv32_tb is
...
begin
  ...
  if SMC_PSRAM_EN generate
    psram_model_0_inst: entity astrarv32.psram_model
    generic map (
    ...
    psram_model_1_inst: entity astrarv32.psram_model
    generic map (
      MEM_BYTES => PSRAM_SIZE
    )
    port map (
  ...
  -- -------------------------------------------------------------------------------------------
  slink_buffer: entity astrarv32.astrarv32_prim_fifo
  generic map (
    AWIDTH  => 0,
    DWIDTH  => 32+4+1,
    OUTGATE => true
