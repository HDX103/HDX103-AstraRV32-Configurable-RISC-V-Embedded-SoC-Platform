# -- ================================================================================ --
# -- ASTRARV32 - Vivado IP Packaging & Customization GUI Setup                          --
# -- -------------------------------------------------------------------------------- --
# -- This scripts packages the entire processor as Vivado IP module including a fancy --
# -- customization GUI. See the ASTRARV32 Datasheet & User Guide for more information.  --
# -- -------------------------------------------------------------------------------- --
...
set astrarv32_home $script_dir/../..
set ip_logo $astrarv32_home/docs/figures/astrarv32_logo_riscv_small.png
set outputdir $script_dir/astrarv32_vivado_ip_work
set ip_top astrarv32_vivado_ip
...
# **************************************************************
create_project "astrarv32-ip" $outputdir
...
# read and process ASTRARV32 SoC file list
set file_list_file [read [open "$astrarv32_home/rtl/file_list_core.f" r]]
set file_list [string map [list {$ASTRARV32_HOME} $astrarv32_home] $file_list_file]
puts "ASTRARV32 source files:"
puts $file_list
add_files $file_list
set_property library astrarv32 [get_files $file_list]

# IP top module and AXI4 bridge
add_file $astrarv32_home/rtl/system_integration/xbus2axi4_bridge.vhd
add_file $astrarv32_home/rtl/system_integration/$ip_top.vhd
...
# Package as IP block
# **************************************************************
ipx::package_project -root_dir $outputdir/packaged_ip -vendor ASTRARV32 -library user -taxonomy /UserIP -import_files -set_current true -force
set_property display_name "ASTRARV32" [ipx::current_core]
set_property vendor_display_name "astrarv32" [ipx::current_core]
set_property company_url https://github.com/stnolting/astrarv32 [ipx::current_core]
set_property description "The ASTRARV32 RISC-V Processor" [ipx::current_core]
...
proc setup_ip_gui {} {
  ...
  set about_text "ASTRARV32 is a small, customizable and extensible MCU-class 32-bit RISC-V soft-core CPU and microcontroller-like SoC."
  ...
  set documentation_text "Find more information online at github.com/stnolting/astrarv32"
  ...
  set_property value_validation_pairs {{ASTRARV32 bootloader} 0 {Custom address} 1 {Internal IMEM image} 2} [ipx::get_user_parameters BOOT_MODE_SELECT -of_objects [ipx::current_core]]
  ...
  set imem_note "IMEM 32kB @ 0x00000000: -Wl,--defsym,__astrarv32_rom_size=32k -Wl,--defsym,__astrarv32_rom_base=0x00000000"
  set dmem_note "DMEM 16kB @ 0x80000000: -Wl,--defsym,__astrarv32_ram_size=16k -Wl,--defsym,__astrarv32_ram_base=0x80000000"
...
ipx::add_file {https://stnolting.github.io/astrarv32/} [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]
