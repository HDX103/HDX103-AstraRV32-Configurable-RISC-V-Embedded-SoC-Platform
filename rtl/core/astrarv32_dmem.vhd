-- ================================================================================ --
-- ASTRARV32 SoC - Data Memory (DMEM)                                                 --
-- -------------------------------------------------------------------------------- --
...
architecture astrarv32_dmem_rtl of astrarv32_dmem is
...
begin
  ...
  for i in 0 to 3 generate -- 4x byte-wide RAMs
    dmem_ram: entity astrarv32.astrarv32_prim_spram
    generic map (
      AWIDTH => AWIDTH-2,
      DWIDTH => 8,
      OUTREG => OUTREG
