-- ================================================================================ --
-- ASTRARV32 CPU - Compressed Instructions Decoder (RISC-V 'C' ISA Extensions)        --
-- -------------------------------------------------------------------------------- --
...
entity astrarv32_cpu_decompressor is
  generic (
...
architecture astrarv32_cpu_decompressor_rtl of astrarv32_cpu_decompressor is
