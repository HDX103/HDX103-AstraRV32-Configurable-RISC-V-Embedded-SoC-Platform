-- ================================================================================ --
-- ASTRARV32 SoC - Bootloader ROM (BOOTROM)                                           --
-- -------------------------------------------------------------------------------- --
...
use astrarv32.astrarv32_bootrom_image.all;

entity astrarv32_bootrom is
  port (
    -- global control --
...
architecture astrarv32_bootrom_rtl of astrarv32_bootrom is
