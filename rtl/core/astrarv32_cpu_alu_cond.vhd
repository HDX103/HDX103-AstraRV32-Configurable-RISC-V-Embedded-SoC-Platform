-- ================================================================================ --
-- ASTRARV32 CPU - ALU Conditional Operations Unit (RISC-V Zicond ISA Extension)      --
-- -------------------------------------------------------------------------------- --
...
entity astrarv32_cpu_alu_cond is
  port (
    -- global control --
...
architecture astrarv32_cpu_alu_cond_rtl of astrarv32_cpu_alu_cond is
