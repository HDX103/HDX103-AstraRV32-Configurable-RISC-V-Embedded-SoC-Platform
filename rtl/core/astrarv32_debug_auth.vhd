-- ================================================================================ --
-- ASTRARV32 OCD - RISC-V-Compatible Authentication Module for the On-Chip Debugger   --
-- -------------------------------------------------------------------------------- --
...
entity astrarv32_debug_auth is
  port (
    -- global control --
...
architecture astrarv32_debug_auth_rtl of astrarv32_debug_auth is
...
begin
  ...
  assert false report "[ASTRARV32] Using DEFAULT on-chip debugger authenticator. Replace by custom module." severity warning;
