## ASTRARV32 in Verilog

[![Verilog Conversion](https://img.shields.io/github/actions/workflow/status/stnolting/astrarv32/Verilog.yml?branch=main&longCache=true&style=flat-square&label=Verilog%20Conversion&logo=Github%20Actions&logoColor=fff)](https://github.com/stnolting/astrarv32/actions/workflows/Verilog.yml)

You can use [GHDL's synthesis feature](https://ghdl.github.io/ghdl/using/Synthesis.html) to convert
a preconfigured ASTRARV32 wrapper setup into a single, synthesizable, **plain-Verilog** module. The
...
certain ASTRARV32 modules by custom Verilog modules. For this purpose, the according ASTRARV32 VHDL
...
* [Convert to Verilog](https://stnolting.github.io/astrarv32/#_convert_to_verilog)
* [Replaceable Modules](https://stnolting.github.io/astrarv32/#_replaceable_modules)

The provided Makefile is used to automate the conversion and to run simulation
with Verilator or Icarus Verilog:

```
astrarv32/rtl/verilog$ make help
ASTRARV32 Verilog Conversion and Test

Targets:
  help       Show this text
  convert    Convert ASTRARV32 to Verilog (generate astrarv32_verilog_wrapper.v)
...
Variables:
  ...
  WRAPPER       VHDL conversion wrapper; default = astrarv32_verilog_wrapper
  VHDL_EXCLUDE  Default ASTRARV32 VHDL core files to exclude from conversion
...
Default ASTRARV32 VHDL files can be excluded from the VHDL-to-Verilog conversion,
...
Example: Replace the default ASTRARV32 DMEM RAM component by a custom Verilog module.
  make VHDL_EXCLUDE=astrarv32_dmem.vhd VERILOG_SRC=modules/astrarv32_dmem.v clean convert sim
```

> [!TIP]
> This flow uses the SoC's VHDL [file-list file](https://stnolting.github.io/astrarv32/#_file_list_file)
for easy customization of the design sources.

> [!NOTE]
> The [Verilog GH actions workflow](https://github.com/stnolting/astrarv32/actions/workflows/Verilog.yml)
