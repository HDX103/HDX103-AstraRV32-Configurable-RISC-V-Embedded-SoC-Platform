...
to setup a minimal ASTRARV32 SoC. These setups are used in the :books:
...
[configuration generics](https://stnolting.github.io/astrarv32/#_processor_top_entity_generics).
...
> [!WARNING]
> Modifying the memory sizes might require adaption of the ASTRARV32 linker script.


### > [`astrarv32_test_setup_approm.vhd`](https://github.com/stnolting/astrarv32/blob/main/rtl/test_setups/astrarv32_test_setup_approm.vhd)
...
The setup uses the ["direct boot"](https://stnolting.github.io/astrarv32/#_direct_boot)
...
> [!TIP]
> See User Guide section [Installing an Executable Directly Into Memory](https://stnolting.github.io/astrarv32/ug/#_installing_an_executable_directly_into_memory).


### > [`astrarv32_test_setup_bootloader.vhd`](https://github.com/stnolting/astrarv32/blob/main/rtl/test_setups/astrarv32_test_setup_bootloader.vhd)
...
The setup uses the ["indirect boot"](https://stnolting.github.io/astrarv32/#_indirect_boot)
configuration, so software applications can be uploaded and run at any timer via the bootloader
and a serial terminal.

> [!TIP]
> See User Guide section [Uploading and Starting of a Binary Executable Image via UART](https://stnolting.github.io/astrarv32/ug/#_uploading_and_starting_of_a_binary_executable_image_via_uart).


### > [`astrarv32_test_setup_on_chip_debugger.vhd`](https://github.com/stnolting/astrarv32/blob/main/rtl/test_setups/astrarv32_test_setup_on_chip_debugger.vhd)
...
> [!TIP]
> See User Guide section [Debugging using the On-Chip Debugger](https://stnolting.github.io/astrarv32/ug/#_debugging_using_the_on_chip_debugger).
